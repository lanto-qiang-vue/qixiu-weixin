...
export default new Router({
	routes: [
		...
		{path: '/remarkMatch', name: 'remark-match', component: resolve => require(['@/page/remark/match'], resolve),meta: {requiresAuth: true, keepAlive: false,}},
		...
		{path: '/coupons-employ', name: 'coupons-employ', component: resolve => require(['@/page/coupons/coupons-employ.vue'], resolve), meta: {requiresAuth: true}},
		...
		{path: '/work-card', name: 'work-card', component: resolve => require(['@/page/push-page/work-card.vue'], resolve),  meta:{requiresAuth: true, title:'电子工牌'}},
